...
export const StayFilter = ({ onChangeFilter }) => {
    ...
    const { txt, placeType,
        maxPrice, minPrice,
        maxRate, minRate,
        minCapacity, amenities,
        checkIn
    } = useSelector(state => state.stayModule.filterBy)

    // Init 
    const [searchParams, setSearchParams] = useSearchParams(txt, placeType,
        maxPrice, minPrice,
        maxRate, minRate,
        minCapacity, amenities,
        checkIn
    ...
    const renderFilterByQueryParams = () => {
        ...
        const filterBy = { txt: queryParams.get('txt') || '',
            ...
            minCapacity: +queryParams.get('min-capacity') || 0,
        }
