...
const logger = createLogger({
    ...
    defaultMeta: {
        ...
        label: 'frontend' // change it to the service name
    },
    transports: [
...
module.exports = {
    debug: (message) => {logger.log('debug', message, true)},

    info: (message) => {logger.log('info', message, true)},

    warn: (message) => {logger.log('warn', message, true)},

    error: (message) => {logger.log('error', message, true)}
}